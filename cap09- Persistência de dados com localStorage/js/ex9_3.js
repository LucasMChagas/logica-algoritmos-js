...
form.addEventListener("submit", (e) => {
    ...
    if (localStorage.getItem("melanciaNome")){
        ...
        localStorage.setItem("melanciaPeso", peso.toString());
    }
...
form.btVencedor.addEventListener("click", (e) => {
    if (!localStorage.getItem("melanciaNome")){
        alert("Não há apostas cadastardas");
        return;
    }
...
form.btLimpar.addEventListener("click", (e) => {
    if (confirm("Confirmar exclusão das apostas?")){
